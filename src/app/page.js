...
export default function Home() {
  ...
  const fetchRankingData = async () => {
    const response = await fetch('http://34.81.183.144:8080/record', {
      headers: {
  ...
  return (
    <div className="background">
                  ...
                  <div key={data.id} style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
                    <div  className="ranking-item">
                      <div style={{ position: 'absolute', top: '-8px', left: '-80px' }}>
                        <Image width={data.rank !== 4 ? 69 : 65} height={data.rank !== 4 ? 98 : 65} src={`http://34.81.183.144:8080/assets/no${data.rank}.png`} alt="rank"/>
                      </div>
      ...
      }
      {
        ...
        message.round === 1 &&
        <Image 
          src="http://34.81.183.144:8080/assets/q1.png"
          width={768}
          height={960}
          alt='q1'
        />
      }
      {
        ...
        message.isCorrect &&
        <Image 
          src="http://34.81.183.144:8080/assets/a1v.png"
          width={768}
          height={960}
          alt="a1v"
        />
      }
      {
        ...
        !message.isCorrect &&
        <Image 
          src="http://34.81.183.144:8080/assets/a1x.png"
          width={768}
          height={960}
          alt='a1x'
        />
      }
      {
        ...
        message.round === 2 &&
        <Image 
          src="http://34.81.183.144:8080/assets/q2.png"
          width={768}
          height={960}
          alt='q2'
        />
      }
      {
        ...
        message.isCorrect &&
        <Image 
          src="http://34.81.183.144:8080/assets/a2v.png"
          width={768}
          height={960}
          alt='a2v'
        />
      }
      {
        ...
        !message.isCorrect &&
        <Image 
          src="http://34.81.183.144:8080/assets/a2x.png"
          width={768}
          height={960}
          alt='a2x'
        />
      }
      {
        ...
        message.round === 3 &&
        <Image 
          src="http://34.81.183.144:8080/assets/q3.png"
          width={768}
          height={960}
          alt='q3'
        />
      }
      {
        ...
        message.isCorrect &&
        <Image 
          src="http://34.81.183.144:8080/assets/a3v.png"
          width={768}
          height={960}
          alt='a3v'
        />
      }
      {
        ...
        !message.isCorrect &&
        <Image 
          src="http://34.81.183.144:8080/assets/a3x.png"
          width={768}
          height={960}
          alt='a3x'
        />
      }
      {
        ...
        message.score === 0 &&
        <Image 
          src="http://34.81.183.144:8080/assets/0p.png"
          width={768}
          height={960}
          alt='0p'
        />
      }
      {
        ...
        message.score === 50 &&
        <Image 
          src="http://34.81.183.144:8080/assets/50p.png"
          width={768}
          height={960}
          alt='50p'
        />
      }
      {
        ...
        message.score === 100 &&
        <Image 
          src="http://34.81.183.144:8080/assets/100p.png"
          width={768}
          height={960}
          alt='100p'
        />
      }
      {
        ...
        message.score === 150 &&
        <Image 
          src="http://34.81.183.144:8080/assets/150p.png"
          width={768}
          height={960}
          alt='150p'
        />
